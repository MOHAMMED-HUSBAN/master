...
function Welcome() {
    const students = [
        ...
        { name: "رامي ��الد الهاشمي", image: "https://scontent.famm7-1.fna.fbcdn.net/v/t39.30808-6/450212731_974908354642368_5543417289759570534_n.jpg" },
        ...
        <div className="min-h-screen bg-white">
                                    ...
                                    <div className="transform transition-all duration-300 hover:scale-105">
                                        <div className="bg-white rounded-lg shadow-md overflow-hidden">
                                            <div className="relative aspect-[4/5]">
                                                ...
                                                />
                                                <div className="absolute inset-0 bg-gradient-to-t from-purple-900/80 via-purple-900/40 to-transparent opacity-0 hover:opacity-100 transition-opacity duration-300">
                                                    <div className="absolute bottom-0 left-0 right-0 p-3 transform translate-y-6 hover:translate-y-0 transition-transform duration-300">
                                            ...
                                            <div className="p-3 text-center bg-white">
                                                <h3 className="text-sm font-semibold text-purple-800">{student.name}</h3>
                                                <p className="text-xs text-gray-600 mt-1">عضو جديد في أكاديميتنا</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
            ...
            <div className="bg-gray-50 py-12">
                <div className="container mx-auto px-4">
                    ...
                    >
                        <blockquote className="text-xl text-purple-800 italic mb-3">
                            "Welcome to Al-Sharq Taekwondo Academy family. Your journey to excellence starts here."
                        </blockquote>
                        <cite className="block text-sm text-gray-600">- Master Aref Alzawahreh</cite>
                    </motion.div>
                </div>
            </div>
        </div>
